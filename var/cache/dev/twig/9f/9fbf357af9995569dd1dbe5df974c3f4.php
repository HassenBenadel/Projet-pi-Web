...
class __TwigTemplate_e3850bdfd1319acc6962c5f17b9d0c31 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["panier"]) {
            ...
            echo "            <tr>
                ...
                <td>";
            // line 25
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["panier"], "totalpanier", [], "any", false, false, false, 25), "html", null, true);
            echo "</td>
...
";
    ...
    {
        return array (  138 => 36,  133 => 33,  124 => 29,  115 => 25,  111 => 23,  106 => 22,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"row\" style=\"display: flex;align-items: rightcenter;justify-content: rightcenter;margin-top: 150px;\">
    ...
    <a href=\"{{ path('app_panier_new') }}\">Passez à la commande</a>
       </div>
        </div>
...
{% endblock %}
", "panier/index.html.twig", "C:\\Users\\EYA\\Desktop\\Commande\\Commande\\templates\\panier\\index.html.twig");
    }
}
